...
100.times do |i|
  ...
  Product.seed do |s|
    ...
    s.image = File.open(["#{Rails.root}/db/fixtures/image_file/014.jpg","#{Rails.root}/db/fixtures/image_file/5503321i.jpeg","#{Rails.root}/db/fixtures/image_file/arm_tablet (1).png","#{Rails.root}/db/fixtures/image_file/karaoke.png","#{Rails.root}/db/fixtures/image_file/shopping_supermarket_man.png","#{Rails.root}/db/fixtures/image_file/shopping_supermarket_family_mother.png","#{Rails.root}/db/fixtures/image_file/yusyou_champagne_fight.png"].sample)
  end
